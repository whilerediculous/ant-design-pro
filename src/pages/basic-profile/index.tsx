...
@connect(
  ({
    ...
    basicProfile,
    loading: loading.effects['basicProfile/fetchBasic'],
  }),
)
class BasicProfile extends Component<BasicProfileProps, BasicProfileState> {
  componentDidMount() {
    const { dispatch } = this.props;
    dispatch({
      type: 'basicProfile/fetchBasic',
    });
  }

  render() {
    const { basicProfile, loading } = this.props;
    const { basicGoods, basicProgress } = basicProfile;
